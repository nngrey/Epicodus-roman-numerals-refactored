...
describe('numeral_converter') do
  ...
  it('will return "III" for 3') do
    numeral_converter(3).should(eq("III"))
  end
  ...
  it('will return an error message for number over 3999') do
    numeral_converter(4000).should(eq("Please enter a numer less than 4000"))
  end
end
